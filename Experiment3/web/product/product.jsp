            ...
            <div class="col-md-10 col-xs-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        <a href="\index" class="panel-title" style="display:inline;">产品列表</a>－
                        <h3 class="panel-title"style="display:inline;">产品管理</h3>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<c:url value="/products"/>" onsubmit="return checkProduct('add');" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="addNote" class="form-control" name="note"></textarea>
                    </div>
                </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<c:url value="/products"/>" onsubmit="return checkProduct('edit');" method="post">
                <div class="modal-body">
